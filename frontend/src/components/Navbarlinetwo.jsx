        ...
        <div>
            ...
            <div className='nav'>
                <div className="containernav">
                    ...
                    <ul>
                        <li style={{ display: "flex", gap: "4px", marginTop: "4px" }} className='borderwhite'>
                        ...
                        <li className='borderwhite'>
                            <Link href="/womenShoes">  Old Songs</Link>
                        </li>
                        <li className='borderwhite'>
                        ...
                        <li className='borderwhite primeimagehover'>
                            ...
                            <div className='primeimage'>
                                <img style={{ width: "93%", height: "auto", padding: "10px 10px", margin: "auto", justifyContent: "center", border: "0px solid red" }} src="https://static.vecteezy.com/system/resources/previews/002/157/610/original/illustrations-concept-design-podcast-channel-free-vector.jpg"></img>
